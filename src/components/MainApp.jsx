        ...
        <>
            <main className="main">
                <div className="main-container">
                    <form className="main-form" id="form" action={addIngredient}>
                        <input
                    ...
                    {ingredients.length > 3 && <section className="generate-recipe-container">
                        ...
                        <div className="generate-recipe-container-right">
                            <button className="generate-recipe-btn" onClick={toggleRecipeShown}>Создать рецепт</button>
                        </div>
                    </section>}
                    {!!isRecipeShown && <section className="ai-generated-recipe-container">
